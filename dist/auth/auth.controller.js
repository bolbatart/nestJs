...
let AuthController = class AuthController {
    ...
    async register(registerDto, res) {
        return res.status(common_1.HttpStatus.OK).send(await this.authService.register(registerDto, res));
    }
    ...
    async resetPassword(key, resetPasswordDto, res) {
        console.log(key);
...
__decorate([
    ...
    __metadata("design:paramtypes", [register_user_dto_1.RegisterDto, Object]),
